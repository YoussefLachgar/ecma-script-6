...
proPlanLiStorage.textContent =
  extractStorageValue(proPlanLiStorage.textContent) * 1.5;
basicPlanLiStorage.textContent =
  extractStorageValue(basicPlanLiStorage.textContent) * 1.25;
...
const changePricing = (event) => {
  ...
  document.querySelector('#basic-plan .pricing').textContent = pricing[selection].basic;
  document.querySelector('#pro-plan .pricing').textContent = pricing[selection].pro;
}
